...
jQuery(document).ready(function ($) {
	...
	$('.site-nav__item').on('mouseover', function () {
		...
		if (menuItemPos.top + $submenuWrapper.height() >= windowHeight && $submenuWrapper.height() <= windowHeight) {
			$submenuWrapper.css({
				top: windowHeight - submenuWrapperHeight // bottom: (menuItemPos.top + menuItemHeight)
